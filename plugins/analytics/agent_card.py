...
class AgentCardGenerator:
    ...
    def _collect_capabilities(self) -> List[str]:
        ...
        capability_map = {
            ...
            'onchain': ['on_chain_awareness', 'token_tracking', 'wallet_management', 'contract_interaction', 'wallet_portfolio', 'transaction_history'],
            ...
            'mcp': ['web_search', 'research', 'information_synthesis', 'deep_research', 'report_generation'],
            'engagement': ['smart_engagement', 'engagement_optimization'],
            'intelligence': ['sentiment_analysis', 'content_optimization', 'cross_platform_sentiment', 'sentiment_scoring'],
